...
final class BPTextField: UIView {
    ...
    private let messageLabel: Label =  {
        let label = Label(text: "", font: .nunitoSansRegular(size: 13), textColor: .hex4B4651)
        return label
    }()
...
//        textField.layer.cornerRadius = 7
        ...
        textField.font = .nunitosSansBold(size: 14)
    ...
    convenience init(title: String, textColor: UIColor? = .hex4B4651, font: UIFont =  .nunitoSansRegular(size: 13), placeHolder: String, hasIcon: Bool = false) {
